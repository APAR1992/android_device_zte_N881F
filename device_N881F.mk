...
PRODUCT_COPY_FILES += \
		...
		device/zte/N881F/prebuilt/system/etc/permissions/android.hardware.sensor.gyroscope.xml:system/etc/permissions/android.hardware.sensor.gyroscope.xml \
        ...
        device/zte/N881F/prebuilt/system/etc/permissions/android.hardware.usb.host.xml:system/etc/permissions/android.hardware.usb.host.xml \
